...
/* 0x38 */	cmp_r2r_b/we, cmp_r2r_l/we, inv, cmp_m2r_l/we, 
...
/* 0x80 */	cmp_i2m_b/we, cmp_add_l/we, nemu_trap, cmp_imm8_l(32位寄存器和8位立即数比/we), sub i8 to r_l/we cmpl i8 to m_l addl i8 to m_l/we  and_i8_rl/we add_i8_rl/we addl_modrm_sib_disp8_imm8/we subl_i8_ml/we
/* 0x84 */	test_rr_b/we, test_r_l(test r32,r32/we), inv, inv, 
/* 0x88 */	mov_r2rm_b, mov_r2rm_v, mov_rm2r_b, mov_rm2r_v,
/* 0x8c */	inv, lea_disp8/32(r)_r/we,(disp32(,rl,ss)/we, inv, inv, 
/* 0x90 */	nop/we, inv, inv, inv,
...
/* 0x8c */	jl_l/we, inv, jle_i32/we, inv, 
